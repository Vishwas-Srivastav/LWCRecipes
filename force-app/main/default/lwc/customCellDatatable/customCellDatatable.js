...
const COLUMNS = [
    ...
    { label: 'Website', fieldName: 'url', type: 'url', typeAttributes: { label: { fieldName: 'name' }, target: '_blank' } },
...
export default class CustomCellDatatable extends LightningElement {
    ...
    @track data = [
        ...
        { id: '2', name: 'Mobile App Migration', url: 'https://developer.salesforce.com', budget: 85000, status: 'In Review' }
    ];
}
